...
elisa_bus = session_bus.get_object("org.mpris.MediaPlayer2.elisa",
...
def get_song_and_post():
    ...
    spotify_properties = dbus.Interface(elisa_bus,
    ...
    if playback_status == "Playing" and (current_artist != last_artist or current_song != last_song):
        was_playing = True
